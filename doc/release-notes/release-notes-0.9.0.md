Theoscoin Core version 0.9.0 is now available from:
...
Rebranding to Theoscoin Core
---------------------------

To reduce confusion between Bitcoin-the-network and Bitcoin-the-software we
have renamed the reference client to Theoscoin Core.
